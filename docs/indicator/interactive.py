...
target = dmc.Center(dmc.Indicator(dmc.Avatar(DashIconify(icon="ci-mail", height=75 ), variant="outline"), id=TARGET_ID))

configurator = Configurator(target, TARGET_ID)
#
configurator.add_colorpicker("color", "indigo")
configurator.add_select("position",["bottom-end", "bottom-start", "top-end",  "top-start" , "bottom-center" , "top-center", "middle-center", "middle-end", "middle-start"], "top-end")
