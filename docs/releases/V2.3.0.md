...
[RichTextEditor](/components/richtexteditor) is now build ton Tiptap V3 enabling features like  `BackgroundColor`, `FontFamily`, `FontSize`, `LineHeight`.

There are no known breaking changes when upgrading. If you’ve built custom controls, check the Tiptap V3 docs to confirm compatibility.
