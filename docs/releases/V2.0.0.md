...
This version is built on [Mantine 8](https://v8.mantine.dev/changelog/8-0-0/), so there are some breaking changes, but as promised, far fewer than in previous
...
- See the [Mantine Changelog](https://v8.mantine.dev/changelog/8-0-0/#other-changes) for other changes.
