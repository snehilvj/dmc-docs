        ...
        dmc.Container(
            ...
            children=[
                ...
                dmc.Box([
                    ...
                    #version-update
                    dmc.Center(dmc.Anchor("dash-mantine-components=1.2.0" , underline=False, href="https://github.com/snehilvj/dash-mantine-components/discussions/categories/releases", target='_blank')),
